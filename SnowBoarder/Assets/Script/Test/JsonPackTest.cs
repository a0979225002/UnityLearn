...
namespace SnowBoarder
{
    public class JsonPackTest
    {
        ...
        {
            var d = JsonUtility.FromJson<T>(data);
            return d;
        }
        ...
        private void SerializationTime()
        {
            ...
            for (var i = 0; i < 100; i++)
            {
                var a1 = Utils.TestFunctionTime(() => Serialization(100, "Json序列化"));
                Deserialization<MessagePackModel1>(a1.Data);
                time1 += a1.Time;
            }

            Debug.Log("==========Adam Json序列化 : 時間" + time1 / 100 + " =========== 數單據數量 :" + 100 +
                      " =========== 總單數 :" + 100);
            ...
            Debug.Log("==========Adam Json序列化 : 時間" + time2 / 100 + " =========== 數單據數量 :" + 100000 +
                      " =========== 總單數 :" + 100);
        }
        ...
        private void DeserializationTime()
        {
            ...
            Debug.Log("==========Adam Json反序列化 : 時間" + time1 / 100 + " =========== 數單據數量 :" + 100 +
                      " =========== 總單數 :" + 100);
            ...
            Debug.Log("==========Adam Json反序列化 : 時間" + time2 / 100 + " =========== 數單據數量 :" + 100000 +
                      " =========== 總單數 :" + 100);
        }
